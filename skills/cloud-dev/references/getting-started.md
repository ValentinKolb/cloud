...
# Build the first Cloud application
...
[Choose the project shape](./architecture.md#page-build-choose-the-project-shape).
...
See [Define an application](./application.md#page-build-define-app) for the complete
definition.
...
Add [request middleware](./middleware.md#page-server-middleware) when the application needs
...
path, follow
[Diagnose an unreachable route](./architecture.md#page-build-routing-diagnose-an-unreachable-route).
...
- [Define typed HTTP APIs](./http.md#page-server-http).
- [Store domain data](./data.md#page-data-postgres-queries).
- [Add SSR pages](./frontend.md#page-frontend-ssr-pages-and-routing).
- [Declare settings](./settings.md#page-platform-settings).
- [Run setup and background work](./architecture.md#page-build-lifecycle).
