...
See [Resource API keys](./credentials.md#page-identity-resource-api-keys) for service-account
...
1. use a [route policy](./route-access.md#page-identity-route-policies);
