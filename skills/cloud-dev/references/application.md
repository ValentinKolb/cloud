...
[Routes and discovery](./architecture.md#page-build-routing).
...
| --- | --- | --- |
| `settings` | Typed runtime configuration | [Settings](./settings.md#page-platform-settings) |
...
| `openapi` | Public OpenAPI document path | [Typed HTTP APIs](./http.md#page-server-http-publish-openapi) |
...
See [Request middleware](./middleware.md#page-server-middleware).
