...
const portableSections = [
  ...
  },
  {
    ...
    pages: [
      ...
      page("image-cropper", "ImageCropper", "ti ti-crop", "Interactive crop, zoom, resize, and rotation."),
      ...
      page("filters", "FilterChip", "ti ti-filter", "Section-aware single and multi-select filtering."),
