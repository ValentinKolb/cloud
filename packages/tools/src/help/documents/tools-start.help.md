...
Tools is a workspace for small generators, encoders, security utilities, media tools, and network tests. Every tool is discoverable from the overview before you choose one.
...
:::info Webhook tester data
Webhook endpoints and request logs are stored on the server for inspection. The tester redacts sensitive headers such as Authorization and Cookie before logging.
:::
