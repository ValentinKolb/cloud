...
const app = new Hono<AuthContext>()
  ...
  .get("/admin-queue", async (c) => {
    ...
    const expiring =
      summary.ipaExpiring30d + summary.localUserExpiring30d + summary.localGuestExpiring30d;
    ...
    blocks.push({
      ...
      pills: [
        ...
        ...(summary.openRequests > 0
          ? [{ label: "queue", value: summary.openRequests, tone: "amber" as const }]
          : []),
      ],
    });
