...
const OPERATIONS: readonly OperationConfig[] = [
  {
    ...
    label: "Force Sync",
    icon: "ti ti-refresh",
    redirectTo: "/admin/logging?source=auth:ipa:sync",
  ...
  },
  {
    ...
    redirectTo: "/admin/logging?source=auth:ipa:backfill",
  ...
  },
  {
    ...
    icon: "ti ti-user-exclamation",
    redirectTo: "/admin/logging?source=auth:local-user:backfill",
  ...
  },
  {
    ...
    icon: "ti ti-user-exclamation",
    redirectTo: "/admin/logging?source=auth:guest:backfill",
  ...
  },
  {
    ...
    redirectTo: "/admin/logging?source=auth:reminder:daily",
