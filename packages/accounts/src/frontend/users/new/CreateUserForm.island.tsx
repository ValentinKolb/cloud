...
const PROVIDER_CARD_CLASS =
  "group flex min-h-40 flex-col items-start gap-3 rounded-xl bg-zinc-50/85 px-4 py-4 text-left ring-1 ring-inset ring-zinc-200/65 transition hover:bg-blue-50/45 hover:ring-blue-400/45 dark:bg-zinc-900/70 dark:ring-zinc-800/80 dark:hover:bg-blue-950/20 dark:hover:ring-blue-500/35";
