...
Accounts shows your own account context and gives admins one place to manage users, groups, account requests, API keys, notification batches, and account history.
