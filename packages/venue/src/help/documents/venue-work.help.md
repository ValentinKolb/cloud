...
- **Feedback:** Shows rating trends, comment search, and 7-, 14-, or 30-day filters for public feedback entries.
- **Public sections:** Admins can add, edit, duplicate, or delete markdown, menu, notice, and links sections.
