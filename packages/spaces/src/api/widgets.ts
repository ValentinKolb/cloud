...
const formatTimeRange = (startsAt: string | null, endsAt: string | null): string => {
...
const app = new Hono<AuthContext>()
  ...
  .get("/today", async (c) => {
    ...
    const items: WidgetListItem[] = [
      ...snap.events.map((e): WidgetListItem => ({
        icon: "ti ti-clock",
        iconTone: "blue",
        label: e.title,
        sub: e.spaceName,
        meta: formatTimeRange(e.startsAt, e.endsAt),
