...
Spaces is for shared work that needs tasks, events, lists, assignees, comments, and lightweight planning. It keeps day-to-day work in one place without forcing every team into a database model.
