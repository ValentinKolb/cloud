...
export const positionTooltip = (tooltip: HTMLElement, target: HTMLElement, placement: TooltipPlacement = "top"): void => {
  ...
  const top = Math.max(VIEWPORT_PADDING, Math.min(useTop ? topPosition : bottomPosition, maxTop));
