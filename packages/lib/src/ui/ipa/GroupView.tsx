import type { BaseGroup } from "@valentinkolb/cloud-contracts/shared";
    ...
    <div class="flex items-start gap-3 min-w-0">
      ...
      <div class="flex flex-col gap-0.5 min-w-0">
        <div class="flex items-center gap-2">
          ...
          {props.canManage && (
            <span
              class="tag bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 shrink-0 flex gap-0.5"
