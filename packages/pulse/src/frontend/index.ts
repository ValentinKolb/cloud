...
export default new Hono<AuthContext>()
  ...
  .get("/:baseId/resources/:resourceKey", auth.requireRole("user", auth.redirectToLogin), ...basePage)
  .get("/:baseId/resources", auth.requireRole("user", auth.redirectToLogin), ...basePage)
  ...
  .get("/:baseId/metrics/:signalId", auth.requireRole("user", auth.redirectToLogin), ...basePage)
  .get("/:baseId/states/:signalId", auth.requireRole("user", auth.redirectToLogin), ...basePage)
  .get("/:baseId/events/:signalId", auth.requireRole("user", auth.redirectToLogin), ...basePage)
  .get("/:baseId/signals/events", auth.requireRole("user", auth.redirectToLogin), ...basePage)
  .get("/:baseId/signals/states", auth.requireRole("user", auth.redirectToLogin), ...basePage)
  .get("/:baseId/signals/metrics", auth.requireRole("user", auth.redirectToLogin), ...basePage)
  .get("/:baseId/signals", auth.requireRole("user", auth.redirectToLogin), ...basePage)
