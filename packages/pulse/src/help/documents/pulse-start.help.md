...
order: 100
---
Pulse turns incoming telemetry into browsable data, query results, and dashboards. The Pulse overview lists every base you can access and lets you create or open one before any source or signal is selected. Start from the question you have, then let the UI reveal the source, resource, signal, and filters you need.
