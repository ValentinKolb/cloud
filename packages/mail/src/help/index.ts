...
import security from "./documents/mail-security.help.md" with { type: "text" };
...
export const mailHelp = defineHelp({
  documents: [start, work, compose, collaboration, security, admin, automation, workflows, troubleshooting],
});
