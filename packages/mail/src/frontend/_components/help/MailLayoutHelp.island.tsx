...
type Props = { documents: readonly HelpDocumentManifest[]; initialTopic?: string; mode?: "register" | "page" };

const HELP_PAGE_BASE = "/app/mail/help";

export default function MailLayoutHelp(props: Props) {
