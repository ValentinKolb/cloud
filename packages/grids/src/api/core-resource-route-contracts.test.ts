...
describe("core resource OpenAPI contracts", () => {
  test("publishes validation, permission, absence, and conflict responses", async () => {
    ...
    const contracts = [
      ...
      ["post", "/records/{tableId}/{recordId}/files/{fieldId}", ["200", "400", "403", "404", "413"]],
      ["put", "/records/{tableId}/{recordId}/files/{fieldId}/{fileId}", ["200", "400", "403", "404", "413"]],
      ["get", "/records/{tableId}/{recordId}/files/{fieldId}/{fileId}/content", ["200", "400", "403", "404", "409"]],
      ["delete", "/records/{tableId}/{recordId}/files/{fieldId}/{fileId}", ["204", "403", "404"]],
      ...
      ["post", "/records/{tableId}/{recordId}/trash", ["204", "400", "403", "404"]],
