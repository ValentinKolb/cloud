  ...
  forms: [
    {
      ...
      config: {
        ...
        fields: [
          ...
          { kind: "user_input", fieldId: field("transactions.account"), label: "Account", helpText: "Account or payment source.", required: true },
          { kind: "user_input", fieldId: field("transactions.category"), label: "Category", helpText: "Budget or spending category.", required: true },
