...
const ACTION_ICONS: Record<string, string> = {
  ...
  "document.generated": "ti-file-type-pdf",
  "document.metadata.updated": "ti-file-pencil",
  "workflow.record.created": "ti-table-plus",
  "workflow.record.updated": "ti-table-pencil",
  "workflow.document.generated": "ti-file-type-pdf",
...
const ACTION_COLORS: Record<string, string> = {
  ...
  "document.generated": "text-blue-600 dark:text-blue-400",
  "workflow.document.generated": "text-blue-600 dark:text-blue-400",
};
...
const ACTION_LABELS: Record<string, string> = {
  ...
  "workflow.document.generated": "Document generated by workflow",
              ...
              <details class="text-xs">
                ...
                >
                  <i
                    ...
                    aria-hidden="true"
                  />
                  <span class="text-secondary">{ACTION_LABELS[entry.action] ?? entry.action}</span>
                  <Show
