  ...
  -> store snapshot + document run metadata`}
      ...
      <DocSection title="Use data in Liquid">
        ...
        <p class="mt-3 text-dimmed">
          ...
          <DocInlineCode>template</DocInlineCode>, <DocInlineCode>run</DocInlineCode>, and <DocInlineCode>date</DocInlineCode> provide
          stable metadata for numbers and filenames. <DocInlineCode>app</DocInlineCode> contains public platform branding.{" "}
