import { logging } from "@valentinkolb/cloud/core/services";
import { err, paginate, tryCatch, type PageParams, type Paginated } from "@valentinkolb/cloud/lib/server";
...
export const loggingService = {
  entry: {
    list: async (config: { pagination?: PageParams; filter?: { source?: string; level?: string; search?: string } }) => {
