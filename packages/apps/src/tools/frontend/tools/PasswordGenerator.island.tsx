...
import { clipboard, crypto } from "@valentinkolb/cloud/lib/browser";
import { SegmentedControl, Switch } from "@valentinkolb/cloud/lib/ui";
...
const ToggleRow = (props: { children: any; columns?: string }) => (
...
export default function PasswordGenerator() {
  ...
  const password = createMemo(() => {
    ...
    switch (mode()) {
      case "memorable":
        return crypto.password.memorable({
      ...
      case "pin":
        return crypto.password.pin({ length: pinLength() });
      default:
        return crypto.password.random({
          length: randomLength(),
