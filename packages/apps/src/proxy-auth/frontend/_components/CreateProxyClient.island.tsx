...
import { apiClient } from "@/proxy-auth/client";
...
import type { ProxyAuthAllowedGroup, ProxyAuthClient, CreateProxyAuthClient } from "@/proxy-auth/contracts";
...
function CopyButton(props: { text: string }) {
  ...
  return (
    <button type="button" class="btn-simple text-[10px] px-1.5 py-0.5" onClick={handleCopy}>
