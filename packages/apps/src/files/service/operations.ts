...
import { registerSettings, registerGroupLabel } from "@valentinkolb/cloud/core/services";

// ── Settings Registration ──────────────────────────────────────────────

registerGroupLabel("files", "Files");
registerSettings([
  {
...
/**
 * Filegate client instance
 */
const filegate = new Filegate({
  url: env.FILEGATE_URL,
